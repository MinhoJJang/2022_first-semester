...
void checkPoints(Tree *tree, Point data[], int numberOfPoints)
{
    // map 내부에 점이 0개일 경우
    ...
    else if (numberOfPoints > 1)
    {
        ...
        if (numberOf[TR] > 0)
        {
            ...
            checkPoints(tree->top_right, map_data[TR], numberOf[TR]);
        }
        ...
        if (numberOf[TL] > 0)
        {
            ...
            checkPoints(tree->top_left, map_data[TL], numberOf[TL]);
        }
        ...
        if (numberOf[BL] > 0)
        {
            ...
            checkPoints(tree->bottom_left, map_data[BL], numberOf[BL]);
        }
        ...
        if (numberOf[BR] > 0)
        {
            ...
            checkPoints(tree->bottom_right, map_data[BR], numberOf[BR]);
        }
    }
    return;
}
...
int main()
{
    ...
    checkPoints(&tree, input_data, NumberOfPoint);
